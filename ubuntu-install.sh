...
./apt-install.sh repo xfce4 xfce4-goodies tightvncserver texi2html bmap-tools python-bs4 curl python-pycurl libssl-dev iperf3 traceroute | tee install.log3
