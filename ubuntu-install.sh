...
./apt-install.sh repo xfce4 xfce4-goodies tightvncserver texi2html bmap-tools python-bs4 curl python-pycurl libssl-dev | tee install.log3
...
# for testing ntp
./apt-install.sh ntpdate ntpsec-ntpdate | tee install.log9
